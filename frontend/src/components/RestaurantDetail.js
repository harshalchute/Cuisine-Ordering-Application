...
useEffect(() => { 
fetch(`https://zomo-food.vercel.app/restaurant/details/${rName}`,{method:'GET'}) 
.then(response=>response.json()) 
.then(data=>setRestaurant(data.data)) 
...
const fetchMenu=()=>{ 
fetch(`https://zomo-food.vercel.app/menu/${rName}`,{method:'GET'}) 
.then(response=>response.json()) 
.then(data=>setMenu(data.data)) 
} 
...
const openRazorpay=async()=>{
  ...
  orderData = await fetch('https://zomo-food.vercel.app/pay',{
    method:'POST',
...
// open razorpay window
  ...
  handler:function(response){
    ...
    fetch('https://zomo-food.vercel.app/pay/save',{
      method:'POST',
      headers:{'Content-Type':'application/json'},
      body:JSON.stringify({
